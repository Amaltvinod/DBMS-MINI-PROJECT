...
public class ReadList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("READ LIST");

        jButton1.setText("UPDATE READLIST");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        dispose();
        UpdateReadList url=new UpdateReadList();
        url.setVisible(true);
...
// TODO add your handling code here:
           ResultSet rs=CustomerQuery.ViewReadList();
            dispose();
            ViewReadList vrl=new ViewReadList(rs);
            vrl.setVisible(true);
